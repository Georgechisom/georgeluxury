    ...
    <Container>
      <div className="bg-white">
        ...
        <div className="text-center">
          <p className="text-4xl leading text-skyText font-bold">404</p>
            ...
            <p className="mt-2 leading-7 text-skyText font-mono text-lg sm:mt-6 sm:text-lg">
            ...
            <h2 className="text-center capitalize text-skyText text-2xl font-bold py-2">popular pages</h2>
            {
              links.map((link, linkId) => (
                <li key={linkId} className="relative flex gap-x-6 py-4 px-4 text-skyText hover:bg-sky-600 hover:text-white">
                  <div className="flex h-10 w-10 flex-none shadow-sm shadow-skyText hover:shadow-white justify-center items-center">
