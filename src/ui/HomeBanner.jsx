    ...
    <Container className='relative py-5 overflow-hidden'>
        ...
        <div className='absolute inset-0 flex flex-col justify-center px-10'>
          <div className='bg-whiteText/15 w-96'>
            ...
            <p className='text-base md:text-xl font-semibold leading-6 text-skyText/100 max-w-[400px] mt-4 drop-shadow-lg w-80 md:w-full'>The lastest Highest Definition with an increase in resolution for a clearer, more detailed picture</p>
